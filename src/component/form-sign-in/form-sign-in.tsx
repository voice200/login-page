...
const FormSignIn: FC<FormSignInProps> = () => {
  ...
  const [showForgotPasswordAlert, setShowForgotPasswordAlert] =
  ...
  const classHeaderSubtitle = cx(
    'subtitle-sign-in',
    'subtitle-sign-in__position'
  )
          ...
          contentRight={
            <Button
              ...
              handlerEvent={{
                ...
                handler: () => {
                  changeShowForgotPasswordAlert(true)
                },
              }}
            />
          }
